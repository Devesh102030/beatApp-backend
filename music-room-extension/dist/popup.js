...
function Popup() {
  ...
  const [hostSecret, setHostSecret] = reactExports.useState("");
  const [status, setStatus] = reactExports.useState("idle");
  const [error, setError] = reactExports.useState(null);
  const [tabTitle, setTabTitle] = reactExports.useState("");
  const [tabDomain, setTabDomain] = reactExports.useState("");
  ...
  const handleStart = reactExports.useCallback(async () => {
    ...
    chrome.runtime.sendMessage({
      ...
      tabId: 0,
      // service worker will fill this in
      tabTitle,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: s.root, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: s.header, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: s.logo, children: "🎵" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: s.title, children: "Music Room" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: s.tabInfo, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: s.tabTitle, children: tabTitle || "Loading tab..." }),
      tabDomain && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: tabDomain })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { ...s.statusRow, background: cfg.bg }, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: cfg.color }, children: cfg.label })
    ] }),
    error && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: s.error, children: error }),
    !isLive && !isBusy && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: s.fieldGroup, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: s.label, children: "Room Code" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            style: {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: s.fieldGroup, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: s.label, children: "Host Secret" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            style: {
    ...
    !isLive ? /* @__PURE__ */ jsxRuntimeExports.jsx(
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { fontSize: 12, color: "#6b7280", textAlign: "center" }, children: [
        "Broadcasting from ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { style: { color: "#e5e7eb" }, children: tabDomain || tabTitle })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { style: s.btnDanger, onClick: handleStop, children: "■ Stop Broadcast" })
    ] }),
